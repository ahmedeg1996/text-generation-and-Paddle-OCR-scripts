#python run.py -l ar --count 50000 -b 3 -na 2  -w 5 -ft C:\Users\v23ASayed2\Desktop\TextRecognitionDataGenerator\trdg\fonts\ar\alfont_com_AlFont_com_arialbd.ttf -bl 2 -rbl -r -f 128  
import argparse
import errno
import os
import sys
...
def parse_arguments():
    ...
    parser.add_argument(
        "--output_dir", type=str, nargs="?", help="The output directory", default="test/"
    )
    parser.add_argument(
        "-i",
        "--input_file",
